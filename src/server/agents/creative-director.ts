...
export const creativeDirectorAgent: AgentDefinition<typeof conceptArtifactSchema> =
  {
    ...
    buildSystemPrompt: () =>
      [
        ...
        "Creative Canon frameworks are mandatory: output **3–4** concepts in the `concepts` array — each meaningfully different, not minor tweaks.",
