...
export const creativeDirectorAgent: AgentDefinition<typeof conceptArtifactSchema> =
  {
    ...
    buildSystemPrompt: () =>
      [
        "You are the Creative Director. Strategy is approved; you produce a SMALL SET of **meaningfully different** creative routes — not variations on one idea.",
