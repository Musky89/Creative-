...
export default async function DashboardPage() {
  try {
    const [clients, briefRows, pendingReviews, activeWorkflows] = await Promise.all([
      listClients(),
    ...
    return (
      <>
        <PageHeader title="Home" description="Could not load the dashboard." />
        <Card className="max-w-xl border-red-500/30 bg-red-950/25">
